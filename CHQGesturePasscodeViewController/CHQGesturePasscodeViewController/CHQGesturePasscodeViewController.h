...
#import "CHQGestureLockView.h"
#import "CHQGestureLockPreviewView.h"

@protocol CHQGesturePasscodeViewControllerDelegate <NSObject>
@optional
/**
...
@interface GesturePasscodeViewController : UIViewController <CHQGestureLockViewDelegate>
/**
 @brief   The delegate.
 */
@property (nonatomic, weak) id<CHQGesturePasscodeViewControllerDelegate> delegate;
/**
